...
//        simpleCookie.setMaxAge(7 * 24 * 60 * 60);//7天
    ...
    public ShiroFilterFactoryBean shiroFilter(DefaultWebSecurityManager securityManager) {
        ...
        //市场调研主页和添加方法
        hashMap.put("/shopInfo/shop_mobile", "anon");
        hashMap.put("/shopInfo/add", "anon");
        hashMap.put("/test/**", "anon");
        hashMap.put("/staffInfo/add", "anon");
        hashMap.put("/recruit/**", "anon"); //招聘显示，供给微信招聘使用

//        测试专用
//        hashMap.put("/cancelOrder/caiwu/saleCollectList", "anon");
//        hashMap.put("/cancelOrder/**", "anon");//我类个去，这个可不能加啊
